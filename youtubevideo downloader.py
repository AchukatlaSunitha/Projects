...
#Heading Label
Label(root,text='YouTube Video Downloader',font=("Comin Sans MS",15),bg='magenta').place(relx=0.25,rely=0.0)
...
Label(root,text="Enter the file name:",font=("Times New Roman",13),bg="Coral").place(relx=0.05,rely=0.6)
filename_strvar=StringVar(root)
filename_entry=Entry(root,textvariable=filename_strvar,width=50)
